        ...
        <div className=" max-w-lg mx-auto fixed bottom-0 left-1/2 -translate-x-1/2 w-full bg-white border-t border-gray-300 z-10">
            <nav>
                <div className="grid grid-cols-4 text-black">
                    <Link href="/" className="flex flex-col items-center py-2 hover:bg-gray-200">
                        <HiHome size={24} />
                        <span className="font-bold text-[10px]">Beranda</span>
                    </Link>

                    <Link href="/transactions" className="flex flex-col items-center py-2 hover:bg-gray-200">
                        <BiTrendingUp size={24} />
                        <span className="font-bold text-[10px]">Transaksi</span>
                    </Link>

                    <Link href="/management" className="flex flex-col items-center py-2 hover:bg-gray-200">
                        <CgMonday size={24} />
                        <span className="font-bold text-[10px]">Manajemen</span>
                    </Link>

                    <Link href="/settings" className="flex flex-col items-center py-2 hover:bg-gray-200">
